...
def load_data():
    try:
        ...
        # Memastikan nama provinsi UPPERCASE agar cocok dengan GeoJSON
...
if not df.empty:
    ...
    st.markdown("Analisis hubungan Kemiskinan terhadap Akses Internet berdasarkan Template Skripsi.")
    ...
    with c2:
        ...
        # Hitung regresi manual agar tidak butuh statsmodels
    ...
    with c4:
        ...
        st.table(res_df)
        st.warning("⚠️ **Temuan Utama:** Nilai **2.693** menunjukkan ketimpangan pada kelompok Kemiskinan Tinggi - Internet Rendah.")

else:
    st.error("Data tidak ditemukan. Pastikan file 'dataset_cleaned.csv' ada di folder yang sama.")
